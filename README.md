# Hipo Intern Project
The Hipo Internship Challenge app is built on Clean Architecture and MVVM. The app shows members from a given JSON, and users can add members to the member list. The app also has a member search field where users can search members by name. The app includes Unit Tests over Data, Domain, and, UI layers.
### All requirements in the given internship project document are completed appropriately
# Screenshots
<p align="center">
<img src="/previews/homepage.png" width="25%"/>
</p>

# App Architecture
![Architecture](https://user-images.githubusercontent.com/95411289/229372417-20f56a5c-7f97-47a6-9545-73ad43e9ac59.jpg)
...
### Domain Layer:
Domain layer is responsible for handling business logic and sits between Ui and Data layers.Domain Layer includes usecases, repository interfaces, and entities.
...
https://user-images.githubusercontent.com/95411289/232321868-d38224da-fb5a-44ae-a346-796389f6e806.mp4
